...
...generateRows(
  "Computer Stream",
  "A1",
  "CDACBDBDACBDACACABBBADACBBCACABBCBAADAAACBCABBCABCABCABCABCBACCABCABCABCBABCACBBADCABCABCBDABBCBDAAA"
),

...generateRows(
  "Computer Stream",
  "B1",
  "CDDBBDAACABCADACABDBADBCCDBBADBCACBBBDBABCBBBADBBCABCADABBCBBCCBCCADABCBCDBBBCCADABABBBAADCBBCDAAAAA"
),

...generateRows(
  "Computer Stream",
  "C1",
  "BABDCCBCCDCBDAAADDCACADBCBADACCCDBBBBACCADACCBDBAADACCDDBADACDDCCACCBCAAAABACCBABCBAABBACCAABDBAAAAA"
),

...generateRows(
  "Computer Stream",
  "D1",
  "BDAACACACBCACCBBCBBABADBCBCCABBCBCBBCCACABCDBBDACDBBABCADACBCCCDACBCACCCBBCDBABADBDBACBACCAACCBAAAAA"
),
  // // MECHANICAL STREAM
